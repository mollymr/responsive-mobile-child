	...
	<div id="widgets" class="home-widgets">
		...
		<div id="home_widget_3" class="home-widget">
			...
			<?php responsive_mobile_widgets_end(); // after widgets hook ?>
				...
				<div id="home_widget_4" class="home-widget">
			<?php responsive_mobile_widgets(); // above widgets hook ?>

			<?php if( !dynamic_sidebar( 'home-widget-4' ) ) : ?>
				<aside class="widget-wrapper">

					<h3 class="widget-title-home"><?php _e( 'Home Widget 4', 'responsive-mobile' ); ?></h3>
					<div class="textwidget"><?php _e( 'This is your fourth home widget box. To edit please go to Appearance > Widgets and choose 8th widget from the top in area 9 called Home Widget 4. Title is also manageable from widgets as well.', 'responsive-mobile' ); ?></div>
